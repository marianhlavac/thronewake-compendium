...
> [!NOTE]
> The in-game building text has some naming inconsistency (a "Quarry produces stone" description that mentions "clay pits"). Function is the standard Travian layout: four field types plus crop.

Boost buildings raise production of a resource, Travian-style: the **Sawmill** boosts Lumber; the **Mill** and **Bakery** boost Food/crop. These sit alongside the mandatory resource fields.
...
Food (crop) is the game's constraining resource by design — it limits army size and adds a logistics layer.
